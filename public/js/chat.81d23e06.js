    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          // console.log('clicked...')
          message = document.getElementById('message').value; // console.log(message);
...
//     |
//     button(class="delete-btn", style="display: none;") Delete Chat
// `;
...
socket.on('loadNewChat', function (data) {
  ...
  if (sender_id === data.data.reciever_id && reciever_id === data.data.sender_id) {
    var html = "<div class=\"r-user\" >\n              ".concat(data.data.message, "\n            </div>");
    // console.log(html);
...
socket.on('existingChat', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(data) {
    var chats, newHtml, i, c, html, _chatContainer, senderChat;
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          ...
          senderChat = document.querySelectorAll('.sender-user');
                  ...
                  return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                    while (1) switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        chatId = div.getAttribute('data-id');
                        console.log(chatId);
                        _context3.prev = 3;
                        _context3.next = 6;
...
var saveChat = exports.saveChat = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(data) {
    var res, mesg, html, _chatContainer2;
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          if (res.data.status == "success") {
            ...
            html = "<div class=\"sender-user\">\n          ".concat(mesg, "\n        </div>");
            document.getElementById("chat-container").insertAdjacentHTML('beforeend', html);
            //   console.log(document.getElementById("chat-container"))
            //   const socket = io();
            //   console.log(socket)
            socket.emit('newChat', res.data);
            _chatContainer2 = document.getElementById("chat-container");
            _chatContainer2.scrollTop = _chatContainer2.scrollHeight;
          }
          _context5.next = 11;
          break;
        case 8:
...
//# sourceMappingURL=/chat.81d23e06.js.map